...
export const LANDMARKS = [
  ...
  },
  {
    ...
    accent: 0x9f6aff,
    pos: [44, 36],
    intro: 'A Solutions Engineer across the full client lifecycle — technical discovery, demos, and proof-of-concept through implementation, deployment, onboarding, and long-term support — building net-new products that open new markets.',
    stats: [
      { num: 40, suffix: '+', label: 'n8n Integrations' },
      { num: 22, suffix: '', label: 'Client Demos' },
      { num: 64, suffix: '%', label: 'Technical Win Rate' },
      { num: 32, suffix: '', label: 'Client Accounts' },
    ],
    achievements: [
      '22 client demos, 14 advanced to SOW or closed — a 64% technical win rate on deals from $20K–$100K with $1M+ expansion potential',
      'Fortune 10 onsite engagement — led the technical push with the head of global security, driving a $35K upsell plus a custom travel-advisory search tool for another $30K ($65K total account expansion)',
      'Own 32 client accounts end-to-end — implement, deploy, onboard, then embed as the long-term technical account manager',
      'Architected & built a net-new Travel Registry product for higher-ed — concept to client deployment, opening a new vertical and revenue stream',
      'First SE-driven expansion into the utilities vertical — established the company footprint from zero',
      'Designed, built & deployed 40+ n8n integrations in production — REST APIs, webhooks, identity-management integration',
      'Built Archimedes — AI agent orchestration (10 agents, persistent memory, dashboard) plus reusable templates & AI-assisted tooling, shortening POC cycles by ~2 weeks',
    ],
